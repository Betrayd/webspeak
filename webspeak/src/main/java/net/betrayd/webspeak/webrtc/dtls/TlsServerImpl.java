...
public class TlsServerImpl extends DefaultTlsServer {
    ...
    private final VerifyCertificate verifyRemoteCertificate;
    ...
    public TlsServerImpl(CertificateInfo certificateInfo, VerifyCertificate verifyRemoteCertificate) {
    ...
    public static interface VerifyCertificate{
