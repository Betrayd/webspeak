 ...
 * appropriately.
 */
public record CertificateInfo(KeyPair keyPair, Certificate certificate, String localFingerprintHashFunction, String LocalFingerPrint, long creationTimestampMs) {
}
